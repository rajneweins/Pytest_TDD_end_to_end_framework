...
schema = pa.schema(
    [
        ...
        ("IS_INTERVAL", pa.int32(), False),
        ("IS_INSTRUMENTATION", pa.int32(),False),
        ("IS_PQM", pa.int32(), True),
...
data = (
    ("24a36712f1c", datetime(2023, 10, 4, 10, 0, 0), 54, "Period 1", "Type A", "Subtype W", "Tier 1", "UOM 1",
     "Direction 1",
     "Quadrant A", "Reading 1", "Reading 1", 1, 0, 0, 0, 1, 15),
    ("24a36712f1c", datetime(2023, 10, 4, 11, 3, 0), 55, "Period 2", "Type B", "Subtype X", "Tier 2", "UOM 2",
     "Direction 2",
     "Quadrant B", "Reading 2", "Reading 2", 2, 0, 0, 0, 1, 15),
    ("24a36712f1c", datetime(2067, 10, 4, 12, 15, 0), 56, "Period 3", "Type C", "Subtype Y", "Tier 3", "UOM 3",
     "Direction 3",
     "Quadrant C", "Reading V2", "Reading V1", 3, 0, 0, 0, 1, 15)
)
