...
data = (
    ("24a36712f1c", datetime(2023, 10, 4, 10, 0, 0), 54, "Period 1", "Type A", "Subtype W", "Tier 1", "UOM 1",
     "Direction 1",
     "Quadrant A", "Reading 1", "Reading 1", 1, 1, 0, 0, 0, 15),
    ("24a36712f1c", datetime(2099, 10, 4, 12, 15, 0), 54, "Period 3", "Type C", "Subtype Y", "Tier 3", "UOM 3",
     "Direction 3",
     "Quadrant C", "Reading V2", "Reading V1", 3, 1, 0, 0, 0, 15)
)
